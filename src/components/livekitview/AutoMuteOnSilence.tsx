...
/**
 * [기능 컴포넌트: AutoMuteOnSilence]
 * 사용자의 발화가 감지되지 않는 침묵 상태가 10초 이상 지속될 경우 마이크를 자동으로 음소거합니다.
 * - AudioContext와 AnalyserNode를 이용해 실시간 오디오 레벨 측정
 * - 단순 레벨 체크뿐만 아니라 FaceDetector(얼굴 인식)를 병행하여,
 *   화면 앞에 사용자가 있으면 말을 안 하더라도 음소거하지 않도록 방지합니다.
 * - 마이크가 꺼진 상태에서 말을 하면 "마이크가 꺼져있습니다" 알림을 띄웁니다.
 */
export const AutoMuteOnSilence = () => {
